...
> **Project location:** `~/defthon` on the Mac.
> OrbStack auto-mounts the Mac home into the VM at `/Users/omaralzhrani/defthon`,
...
| `error: no such command: 'xtask'` | You're outside the project. `cd ~/defthon` first. |
...
│                         │                    │                              │
│  ~/defthon              │ ◀── same files ──▶ │ /Users/omaralzhrani/defthon  │
